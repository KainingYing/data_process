...
class social_relation_dataset(BaseDataset):
    DATA_METAINFO = {
        ...
        "save_image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/taskonomy_evaluation_data/relation_reasoning/social_relation_recognition/images",
        "sampling_num": 200,
    ...
    def generate_qa(image_info, dataset_info, save_image_path):
        ...
        sys_prompt = '\n'.join(mmcv.list_from_file('/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/prompt/multi_classification.txt'))
