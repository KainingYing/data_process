...
class visual_genome_sg(BaseDataset):
    DATA_METAINFO = {
        ...
        "anno_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/OpenDataLab___Visual_Genome_Dataset_V1_dot_2/raw/data/relationships.json",
        "image_data_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/OpenDataLab___Visual_Genome_Dataset_V1_dot_2/raw/data/image_data.json",
        "sampling_num": 50,
...
class vrd_sg(BaseDataset):
    DATA_METAINFO = {
            "anno_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/sg/sg_dataset/json_dataset/annotations_test.json",
            "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/sg/sg_dataset/sg_test_images",
            "sampling_num": 50,
            "visual_input_component": ["natural_image"],
            "dataset_description": "xxx"}
    ...
    def parse_dataset_info(self):
        super().parse_dataset_info()
        self.category_space = mmcv.load("/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/sg/sg_dataset/json_dataset/predicates.json")
...
class vsr(BaseDataset):
    DATA_METAINFO = {
            "anno_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/vsr_zeroshot/dev.jsonl",
            "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/coco/train2017",
            "save_image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/taskonomy_evaluation_data/relation_reasoning/scene_graph_recognition/images",
            "sampling_num": 200,
            "visual_input_component": ["natural_image"],
            "dataset_description": "xxx"}
