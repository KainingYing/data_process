...
class other_biological_attributes(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/shaowenqi/taskonomy_data/medical_understanding/other_biological_attributes",
        "anno_path": "/mnt/petrelfs/share_data/shaowenqi/taskonomy_data/medical_understanding/other_biological_attributes/metadata_info.json",
        "sampling_num": 200,
