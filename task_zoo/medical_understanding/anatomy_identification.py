...
class anatomy_identification(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/shaowenqi/taskonomy_data/medical_understanding/anatomy_identification",
        "anno_path": "/mnt/petrelfs/share_data/shaowenqi/taskonomy_data/medical_understanding/anatomy_identification/metadata_info.json",
        "sampling_num": 200,
