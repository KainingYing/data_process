...
class medical_modality_recognition(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/shaowenqi/taskonomy_data/medical_understanding/modality_recognition",
        "anno_path": "/mnt/petrelfs/share_data/shaowenqi/taskonomy_data/medical_understanding/modality_recognition/metadata_info.json",
        "sampling_num": 200,
