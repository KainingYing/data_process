...
class disease_diagnose(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/shaowenqi/taskonomy_data/medical_understanding/disease_diagnose",
        "anno_path": "/mnt/petrelfs/share_data/shaowenqi/taskonomy_data/medical_understanding/disease_diagnose/metadata_info.json",
        "sampling_num": 200,
