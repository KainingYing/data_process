...
class Garbage_Classification_12(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/waste/Garbage_Classification_12/garbage_classification",
        "sampling_num": 100,
        "url": "internet",
...
class Waste_Classification_data(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/waste/Waste_Classification_data/dataset/DATASET/TEST",
        "sampling_num": 100,
        "url": "internet",
        "visual_input_component": ["natural_image"],
        "dataset_description": "xxx"
