...
class flower_photos(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/visual_recognition/plant_recognition/flower_photos",
        "sampling_num": 100,
...
class Plant_Data(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/visual_recognition/plant_recognition/Plant_Data/Plant_Data/valid",
        "sampling_num": 100,
        "visual_input_component": ["natural_image"],
        "dataset_description": "xxx"
    }
