...
class chemical_apparatus_image_dataset(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/chemical/Chemical_Apparatus_Image_Dataset/Test/Images",
        "anno_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/chemical/Chemical_Apparatus_Image_Dataset/Test/Labels",
        "sampling_num": 200,
        "url": "",
    ...
    def parse_images_info(self):
        ...
        for image_path in Path(self.image_path).iterdir():
            ...
            for label_line in label_list:
                ...
                crop_and_save_image_center(image_path, (x, y, w, h), f"/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/chemical/crop_images/{new_image_name}")

                image_info = self.image_dict(f"/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/chemical/crop_images/{new_image_name}")
                image_info.update(
                    {
                        "original_image_path": f"/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/chemical/crop_images/{new_image_name}",
                        "category": category
                    }
                )
