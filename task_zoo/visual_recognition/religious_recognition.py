...
class religious_symbols_image_classification(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data/religious/dataset_a/Symbols",
        "sampling_num": 100,
...
class dataset_of_traditional_chinese_god_statue(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/religious/dataset_b/Dataset_of_traditional_Chinese_god_statue/traditional_Chinese_god_statue/Original",
        "sampling_num": 100,
