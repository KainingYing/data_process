...
class FairFace(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/zhangkaipeng/TaskOnomy/Vision Recognition-Age, Gender or Race",
        "anno_path": "/mnt/petrelfs/share_data/zhangkaipeng/TaskOnomy/Vision Recognition-Age, Gender or Race/metadata_dataset.json",
        "sampling_num": 200,
        "url": "internet",
