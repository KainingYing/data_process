...
class musical_instruments_image_classification(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/Music_Instruments/dataset_a/test",
        "sampling_num": 100,
...
class music_instruments_classification(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/Music_Instruments/dataset_b/instruments_data",
        "sampling_num": 100,
