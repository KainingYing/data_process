...
class CNNGestureRecognizer(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/visual_recognition/gesture_recognition/CNNGestureRecognizer/imgfolder_b",
        "sampling_num": 100,
...
class gesture_digits(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/visual_recognition/gesture_recognition/gesture_digits/picture",
        "sampling_num": 100,
        "visual_input_component": ["natural_image"],
        "dataset_description": "xxx"
    }
