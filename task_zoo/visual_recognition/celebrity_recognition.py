...
class lfw(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/zhangkaipeng/TaskOnomy/Vision Recognition-Celebrity",
        "anno_path": "/mnt/petrelfs/share_data/zhangkaipeng/TaskOnomy/Vision Recognition-Celebrity/metadata_dataset.json",
        "sampling_num": 200,
        "url": "internet",
