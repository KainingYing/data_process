...
class animals90(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/animals/Animal_Image_Dataset_90/animals/animals",
        "sampling_num": 50,
        "url": "internet",
...
class animals150(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/animals/animals150/dataset/dataset",
        "anno_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/animals/animals150/translation.json",
        "sampling_num": 100,
        "url": "internet",
        "visual_input_component": ["natural_image"],
        "dataset_description": "xxx"
...
class animals10(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/animals/animals10/raw-img",
        "anno_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/animals/animals150/translation.json",
        "sampling_num": 50,
        "url": "internet",
        "visual_input_component": ["natural_image"],
