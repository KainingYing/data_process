...
class e_waste(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/visual_recognition/electronic_object_recognition/e-waste/test",
        "sampling_num": 150,
...
class electronics_object_image_dataset_computer_parts(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/visual_recognition/electronic_object_recognition/electronics_object_image_dataset_computer_parts/samples_for_clients/samples_for_clients",
        "anno_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/visual_recognition/electronic_object_recognition/electronics_object_image_dataset_computer_parts/annotations/annotations",
        "sampling_num": 50,
        "visual_input_component": ["natural_image"],
