...
class TAU_Vehicle_Type_Recognition(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/visual_recognition/vehicle_recognition/TAU_Vehicle_Type_Recognition/train/train",
        "sampling_num": 100,
...
class vehicle_type_recognition(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/visual_recognition/vehicle_recognition/vehicle-type-recognition",
        "sampling_num": 100,
        "visual_input_component": ["natural_image"],
