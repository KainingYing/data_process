...
class ade20k_pixel_recognition(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/ade20k_/ade20k/images/validation",
        "anno_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/ade20k_/ade20k/annotations/validation",
        "sampling_num": 100,
        "visual_input_component": ["natural_image"],
        "dataset_description": "xxx"
    }
    ...
    def parse_images_info(self):
        ...
        category_info_list = mmcv.list_from_file("/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/ade20k_/ade20k/objectInfo150.txt")
