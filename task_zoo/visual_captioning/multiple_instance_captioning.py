...
#     DATA_METAINFO = {
#         "anno_path": "/mnt/petrelfs/share_data/liushuo/lvlm_evaluation/Multi-Instances_Captioning/Multi-Instances_Captioning.json",
#         "sampling_num": 200,
...
class flickr30k_multi_regions(BaseDataset):
    CLASSES = ('object',)
    DATA_METAINFO = {
        "anno_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/instance_region/final_flickr_mergedGT_val.json",
        "img_prefix": "/mnt/petrelfs/yingkaining/project/MarkLLaVA/LLaVA/data/markllava/finetune/flickr30k-images",
        "sampling_num": 200,
