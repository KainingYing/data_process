...
class visual_genome_caption(BaseDataset):
    CLASSES = ('object',)
    DATA_METAINFO = {
        "anno_path": "/mnt/petrelfs/share_data/lizhiqian/metainfo/instance.json",
        "img_prefix": "/mnt/petrelfs/yingkaining/project/MarkLLaVA/LLaVA/data/markllava/finetune/mark/visual_genome/vg_all",
        "save_image_path": "",
        "sampling_num": 100,
    ...
    def parse_images_info(self):
        self.data_infos = self.load_annotations("/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/instance_region/test.json")
...
class refcocog_caption(BaseDataset):
    ...
    DATA_METAINFO = {
        "anno_path": "/mnt/petrelfs/share_data/lizhiqian/metainfo/instance.json",
        "img_prefix": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/coco/train2014",
        "sampling_num": 100,
        "visual_input_component": ["natural_image", ],
        "dataset_description": "a picture may contains multiple regions and multiple instances, the caption is made towards a certain instance/region"
    }
    ...
    def parse_images_info(self):
        self.data_infos = self.load_annotations("/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/instance_region/finetune_refcocog_val.json")
        self.images_info = list()
