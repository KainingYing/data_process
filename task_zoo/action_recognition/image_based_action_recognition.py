...
class HAR(BaseDataset):
    DATA_METAINFO = {
        "anno_path": "/mnt/petrelfs/share_data/wangjin/lvlm_evaluation/taskonomy_evaluation_data/action_recognition/image_based_action_recognition/metadata_info.json",
        "sampling_num": 100,
