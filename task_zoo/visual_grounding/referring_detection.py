...
class RefCOCO_refer(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/coco/train2014",
        "anno_path": "/mnt/petrelfs/share_data/zhangwenbo/Referring_Detection/refer/data/metadata.json",
        "sampling_num": 50,
...
class RefCOCOg_refer(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/coco/train2014",
        "anno_path": "/mnt/petrelfs/share_data/zhangwenbo/Referring_Detection/refer/data/metadatag.json",
        "sampling_num": 100,
        "visual_input_component": ["natural_image",],
