...
class market_1501(BaseDataset):
    DATA_METAINFO = {
        "anno_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/retrieval/market_1501/Market-1501-v15.09.15",
        "sampling_num": 200,
    ...
    def parse_images_info(self):
        ...
        query_path = Path("/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/retrieval/market_1501/Market-1501-v15.09.15/query")
        galley_path = Path("/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/retrieval/market_1501/Market-1501-v15.09.15/bounding_box_test")
