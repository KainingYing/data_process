...
class DES(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/localization/salient_object_detection_rgbd/DES/RGB",
        "anno_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/localization/salient_object_detection_rgbd/DES/GT",
        "depth_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/localization/salient_object_detection_rgbd/DES/depth",
        "sampling_num": 100,
    ...
    def parse_images_info(self):
        ...
        for im in tqdm(image_list):
            ...
            'original_depth_path': original_depth_path.replace('/cpfs01/user/linyuqi/datasets', ' /mnt/petrelfs/share_data/linyuqi'),
            'height': h,
            'width': w
            }
...
class NJU2K(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/localization/salient_object_detection_rgbd/NJU2K/RGB_left",
        "anno_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/localization/salient_object_detection_rgbd/NJU2K/GT",
        "depth_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/localization/salient_object_detection_rgbd/NJU2K/depth",
        "sampling_num": 100,
        "visual_input_component": ["natural_image"],
        "dataset_description": "Note that this dataset have no category space and no train set (only used for testing). We use foreground as the category name"
    }
