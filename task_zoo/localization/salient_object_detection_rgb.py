...
class MSRA10K(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/localization/salient_object_detection_rgb/MSRA10K_Imgs_GT/Imgs",
        "anno_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/localization/salient_object_detection_rgb/MSRA10K_Imgs_GT/Imgs",
        "sampling_num": 100,
...
class DUTS(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/localization/salient_object_detection_rgb/DUTS-TE/DUTS-TE-Image",
        "anno_path": "/mnt/petrelfs/share_data/linyuqi/TaskOnomy_Evaluation/localization/salient_object_detection_rgb/DUTS-TE/DUTS-TE-Mask",
        "sampling_num": 100,
        "visual_input_component": ["natural_image"],
