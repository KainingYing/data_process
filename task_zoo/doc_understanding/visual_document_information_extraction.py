...
class sroie(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/ICDAR-2019-SROIE/data/img",
        "anno_path": "/mnt/petrelfs/share_data/yingkaining/lvlm_evaluation/data_process/data/ICDAR-2019-SROIE/data/key",
        "sampling_num": 200,
        "visual_input_component": ["text-rich_image",],
        "dataset_description": "xxx"
    }
