...
class Deepfashion_keypoint(BaseDataset):
    DATA_METAINFO = {
        "anno_path": "/mnt/petrelfs/share_data/zhanghao1/evaluation_data/finish/keypoint_detection/clothes_keypoint_detection/metadata_info.json",
        "sampling_num": 100,
    ...
    def parse_images_info(self):
        ...
        for image_info in metadata_info["images"]:
            ...
            for keypoint_info in image_info["key_ann"]:
                ...
                import os
                if not os.path.exists(str(Path("/mnt/petrelfs/share_data/zhanghao1/evaluation_data/data/mp100/Deepfashion2") / Path(_image_info["file_name"]).name)):
                    continue
                _image_info["original_image_path"] = str(Path("/mnt/petrelfs/share_data/zhanghao1/evaluation_data/data/mp100/Deepfashion2") / Path(_image_info["file_name"]).name)
