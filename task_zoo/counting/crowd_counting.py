...
class ShanghaiTech(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/zhangkaipeng/TaskOnomy/Crowd Couting",
        "anno_path": "/mnt/petrelfs/share_data/zhangkaipeng/TaskOnomy/Crowd Couting/metadata_dataset.json",
        "sampling_num": 100,
        "url": "internet",
...
class CARPK(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/share_data/zhangkaipeng/TaskOnomy/Crowd Couting/CARPK",
        "anno_path": "/mnt/petrelfs/share_data/zhangkaipeng/TaskOnomy/Crowd Couting/CARPK/test.txt",
        "sampling_num": 100,
        "url": "internet",
        "visual_input_component": ["natural_image"],
