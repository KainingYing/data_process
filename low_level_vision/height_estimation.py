...
class gta_height(BaseDataset):
    DATA_METAINFO = {
        "image_path": "/mnt/petrelfs/yingkaining/yingkaining/lvlm_evaluation/data/height/GTA_height/images/test",
        "anno_path": "/mnt/petrelfs/yingkaining/yingkaining/lvlm_evaluation/data/height/GTA_height/annotations/test",
        "sampling_num": 200,
